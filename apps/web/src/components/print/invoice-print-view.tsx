...
function TopWave({ colors }: { colors: InvoiceAccentPalette }) {
  return (
    <svg
...
function SectionWave({ colors }: { colors: InvoiceAccentPalette }) {
  return (
    <svg
...
function BottomWave({ colors }: { colors: InvoiceAccentPalette }) {
  return (
    <svg
      ...
      <div id="invoice-capture-root" className="max-w-full overflow-x-hidden bg-white">
        ...
        <div className="relative max-w-full px-4 pb-2 pt-2 sm:px-10">
          <header className="invoice-header mx-auto mb-1 flex max-h-[30vh] max-w-xl flex-col items-center justify-center overflow-hidden text-center">
            ...
            {branding.tagline && (
              <p className="mt-0.5 text-xs font-medium" style={{ color: colors.accent }}>
                {branding.tagline}
              </p>
            )}
            ...
            <div className="mt-1.5 flex flex-wrap items-center justify-center gap-x-3 gap-y-0.5 text-[11px] text-slate-600">
              ...
              {branding.email && (
                <span className="inline-flex items-center gap-1">
                  <Mail className="h-3 w-3" style={{ color: colors.accent }} />
                  {branding.email}
                </span>
              )}
              {branding.website && (
          ...
          <div className="mb-8 grid grid-cols-1 gap-6 sm:grid-cols-2 sm:items-start">
            <div className="min-w-0">
              ...
              >
                <div
                  className="mx-auto mb-1.5 flex h-9 w-9 items-center justify-center rounded-full text-sm font-bold text-white shadow-sm"
                  style={{
            ...
            <div className="min-w-0 sm:text-right">
              ...
              <div
                ...
                style={{
                  borderColor: colors.softBorder,
                  backgroundColor: `${colors.softBg}80`,
                }}
              >
            ...
            <section className="mb-6">
              ...
              <div className="grid gap-3 text-sm sm:grid-cols-3">
                <div
                  ...
                  style={{
                    borderColor: colors.softBorder,
                    backgroundColor: `${colors.softBg}66`,
                  }}
                >
                  ...
                  <p className="mt-1.5 inline-flex items-center justify-center gap-1.5 font-semibold text-slate-900">
                    {invoice.shippingMethod === 'AIR' && (
                      <>
                        <Plane className="h-4 w-4" style={{ color: colors.accent }} />
                        Air freight
                      </>
                    )}
                    {invoice.shippingMethod === 'SEA' && (
                      <>
                        <Ship className="h-4 w-4" style={{ color: colors.accent }} />
                        Sea freight
                      </>
                    )}
                  ...
                  <p className="mt-1.5 font-semibold text-slate-900">
                    {invoice.shippingFromCountry || invoice.shippingToCountry ? (
                      <>
                        ...
                        <span className="mx-1.5 font-medium" style={{ color: colors.accent }}>
                          to
                        </span>
          ...
          <div className="mb-8 max-w-full overflow-hidden rounded-xl shadow-sm ring-1 ring-slate-100">
            <table className="w-full table-fixed border-collapse text-sm">
              ...
              <thead>
                <tr style={{ backgroundColor: colors.accent }} className="text-left text-white">
                ...
                <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                  {offerSrcs.map((src, index) => (
                    <div
                      ...
                      className="flex aspect-square items-center justify-center overflow-hidden rounded-xl bg-white shadow-md"
                      style={{ boxShadow: `0 0 0 1px ${colors.softBorder}` }}
                    >
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                      <img
                        src={src}
        ...
        {footerContacts.length > 0 && (
          <footer className="mt-auto max-w-full overflow-hidden">
            ...
            <div
              className="max-w-full px-4 py-5 text-white sm:px-6"
