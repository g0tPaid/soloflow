...
import { registerSchema, type RegisterInput, APP_NAME } from '@flowbooks/shared';
...
export default function RegisterPage() {
  ...
  return (
    <AuthScreen title={`Create your ${APP_NAME} account`} subtitle="Start managing your business today">
